...
import cn.cat.domain.activity.model.valobj.*;
import cn.cat.infrastructure.dao.*;
import cn.cat.infrastructure.dao.po.*;
...
public class ActivityRepository implements IActivityRepository {
    ...
    public List<UserGroupBuyOrderDetailEntity> queryInProgressUserGroupBuyOrderDetailListByOwner(Long activityId, String userId, Integer ownerCount) {
        ...
        return queryOrderDetailList(groupBuyOrderLists);
    }
    ...
    private List<UserGroupBuyOrderDetailEntity> queryOrderDetailList(List<GroupBuyOrderList> groupBuyOrderLists) {
        // 1. 过滤队伍获取 TeamId
        Set<String> teamIds = groupBuyOrderLists.stream()
                .map(GroupBuyOrderList::getTeamId)
